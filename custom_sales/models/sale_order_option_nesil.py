...
class SaleOrderOptionNesil(models.Model):
    ...
    def retro_options_nesil_options(self):
        ...
        for option in options:
            self.env["sale.order.option.nesil"].create({'product_id':option.product_id.id,'line_id':option.line_id.id,'name':option.name,
                ...
                'total_purchase_price':option.total_purchase_price,'order_line_id':option.order_line_id,'nomenclature_name':option.nomenclature_name,
                'total_sale_price':option.total_sale_price,'task_id':option.task_id.id,'planning_id':option.planning_id.id,'work_order_id':option.work_order_id.id,'role_id':option.role_id.id})
